...
@section('content')
    <x-profile.wrap>
        <section class="createArticle">
            ...
            <form action="" class="createArticle__form createArticle__form-article" style="width: 100%;">
                <label for="createArticle-title" class="createArticle__label-titleArticle createArticle-label">Article Title</label>
                <div class="input-wrapper" style="width: 100%;">
                    <input id="createArticle-title" type="text" class="createArticle__input createArticle__input-title input" placeholder="Enter your article title here..." style="width: 100%;"/>
                </div>
                
                <label for="tiptap-editor" class="createArticle__textarea-label createArticle-label">Article Content</label>
                <div class="tiptap-container" style="width: 100%;">
                  ...
                  <button type="button" class="tiptap-button" id="list-ul-btn" title="Bullet List">
                    ...
                    <div class="input-wrapper" style="width: 100%;">
                        <div id="tiptap-editor" class="tiptap-editor" contenteditable="true" style="width: 100%;">
                ...
                <div class="input-wrapper" style="width: 100%;">
                    <input id="Tags" type="text" class="createArticle__tags-input createArticle__input input" placeholder="Search or create tags...(Up to 5)" style="width: 100%;"/>
                </div>
                ...
                <div class="input-wrapper date-wrapper" style="width: 100%;">
                    <input type="text" id="Publish-Date" class="input createArticle__publish-input" placeholder="Schedule a publication date MM/DD/YEAR" style="width: 100%;"/>
                </div>
            </form>
            
            <h4 class="createArticle__subtitle">Featured Image</h4>
            <form action="" class="createArticle__form createArticle__form-image" style="width: 100%;">
                <label class="modern-upload" style="width: 100%;">
            ...
            <form action="" class="createArticle__form createArticle__form-seo" style="width: 100%;">
                <label for="metaTitle" class="createArticle-label createArticle__metaTitle-label">Meta Title:</label>
                <div class="input-wrapper" style="width: 100%;">
                    <input id="metaTitle" type="text" class="createArticle__input-metaTitle input createArticle__input" placeholder="Enter meta title (for search engines)." style="width: 100%;"/>
                </div>
                <label for="metaDescription" class="createArticle-label createArticle__metaDescription-label">Meta Description:</label>
                <div class="input-wrapper" style="width: 100%;">
                    <textarea id="metaDescription" class="createArticle__input-metaDescription input createArticle__input" placeholder="Enter meta description (for search engines)." rows="3" style="width: 100%;"></textarea>
                </div>
            </form>
            
            <div class="createArticle__buttons" style="width: 100%;">
