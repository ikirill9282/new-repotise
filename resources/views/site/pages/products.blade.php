...
@php
    ...
    $location = array_key_exists('country', $params)
        ? \App\Models\Location::firstWhere('slug', $params['country'])
        : null;
                                        ...
                                        <div class="calculate_filtr">
                                            <div class="accordion accordion-flush" id="accordionFlushExample">
                                                            ...
                                                            <div class="price">
                                                                ...
                                                                <div class="slider-container">
                                                                    ...
                                                                    <div class="price-range">
                                                                        <input type="text" class="price-input !text-sm"
                                                                            id="min-price-7" value="0">
                                                                        <input type="text" class="price-input !text-sm"
                                                                            id="max-price-7" value="20000">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="buttons" id="filter_button">
                                                    ...
                                                    <a
                                                        href="{{ $getCurrentUrl() }}">{{ print_var('filter_clear', $variables) }}</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                for (const key in queryParams) {
                    ...
                    if (key === "categories") {
                        value.split(",").map((elem) => {
                            if (elem.length) {
                                const item = makeSearchableItem({
                                    label: capitalizeWords(elem),
                                    slug: elem,
                                });
