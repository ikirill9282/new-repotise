        ...
        <div class="container">
            <div class="grid grid-cols-1 md:grid-cols-[260px_1fr] lg:grid-cols-[300px_1fr] !gap-4 lg:!gap-10">
                ...
                <div class="col-span-1">
                    <div class="accordion bg-white rounded-lg" id="accordion">
                      ...
                      <div id="collapse-main" class="accordion-collapse collapse show" data-bs-parent="accordion">
                          ...
                          <div class="!p-3">
                              ...
                              <div class="" x-data="{
                                  ...
                                  <div class="flex flex-col !gap-4">
                                      ...
                                      <div class="flex px-1 !text-gray !text-sm">
                                          <input x-model="sliderOneValue" x-on:input="(evt) => sliderOne(evt)"
                                              type="text" class="price-input" data-input="integer">
                                          <input x-model="sliderTwoValue" x-on:input="(evt) => sliderTwo(evt)"
                                              type="text" class="price-input text-right" data-input="integer">
                                      </div>
                                  </div>
                              </div>
                          </div>
                          ...
                          <div class="">
                              ...
                              <div class="accordion" id="lang">
                                ...
                                <div id="collapse-lang" class="accordion-collapse collapse" data-bs-parent="lang">
                                  {{-- <div class="max-h-48 overflow-x-hidden overflow-y-auto scrollbar-custom"> --}}
                                    <div class="border-b-2 border-light"></div>
                                    <div class="!py-2 !px-3 text-gray group transition hover:cursor-pointer hover:text-active">
                              ...
                              <div x-data="{}" class="accordion" id="country">
                                ...
                                <div x-ref="collapse" id="collapse-country" class="accordion-collapse collapse" data-bs-parent="country" style="">
                              ...
                              <div class="accordion" id="platform">
                                ...
                                <div id="collapse-platform" class="accordion-collapse collapse !pt-0 text-[15px]" data-bs-parent="platform">
                                  <div class="flex flex-col">
                                    <div class="border-b-2 border-light"></div>

                                    {{-- YOUTUBE --}}
                                    <div class="flex justify-start items-center !gap-2 !p-3 transition hover:cursor-pointer hover:bg-active hover:text-white">
                                      <div class="">
                    ...
                    <ul class="filters__list">
                        ...
                        <li class="filers__item platforms">
                            ...
                            <ul class="filters__platforms-list filter unactive-fiter">
                                ...
                                <li class="filters__platforms-item">
                                    <img src="{{ asset('assets/img/icons/pinterest.svg') }}" alt=""
                                        class="filters__platforms-item-image" />
                                    <p class="filters__platforms-item-name">Pinterest</p>
                                </li>
                                <li class="filters__platforms-item">
                                    <img src="{{ asset('assets/img/icons/threads.svg') }}" alt=""
                                        class="filters__platforms-item-image" />
                                    <p class="filters__platforms-item-name">Threads</p>
                                </li>
                                <li class="filters__platforms-item">
                                    <img src="{{ asset('assets/img/icons/web.svg') }}" alt=""
                                        class="filters__platforms-item-image" />
...
@push('js')
  <script>
      function makeSearchableItem(data) {
          const item = $("<span>", {
            class: 'bg-light rounded !p-1 !text-sm !text-gray flex items-center justify-start !gap-2 group hover:cursor-pointer',
          });
          const remove = $("<a>", {
              href: "#",
              class: "disabled",
