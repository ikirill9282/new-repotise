...
@section('content')
    <x-profile.wrap>
      <div class="createProduct-wrapper">
        <div class="createProduct-wrapper2">
          <h1 class="createArticle__title">Create Product - Media & Files</h1>
          <ul class="createArticle__breadCrumbs">
            ...
            <li class="createArticle__breadcrumb"><a href=""> Create Product (2/2)</a></li>
          </ul>
          <h4 class="createProduct__subtitle">Product Media & Files</h4>
          <form class="createProduct__productsDetails createProduct__madia-form createProduct-wrapper">
            <label for="" class="createArticle-label createProduct__featured-label">Featured Photo</label>
            ...
            <label for="" class="createArticle-label createProduct__additional-label">Additional Photos</label>
            <ul class="createProduct__additional-list">
              <li class="createProduct__additional-item">
                <label class="modern-upload">
                  <input type="file" class="visually-hidden" accept="image/*" />
                  <div class="upload-area">
                    <div class="image-preview">
          ...
          <h4 class="createProduct__subtitle">Product Files</h4>
          <form class="createProduct__productsDetails createProduct__files-form createProduct-wrapper">
            <label for="" class="createArticle-label createProduct__text-label">Post-Purchase Text (Optional):</label>
            <div class="tiptap-container">
              <div class="tiptap-toolbar">
                <button type="button" class="tiptap-button" id="desc2-bold-btn" title="Жирный">
                ...
                <button type="button" class="tiptap-button" id="desc2-align-justify-btn" title="Выровнять по ширине">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                ...
                <button type="button" class="tiptap-button" id="desc2-align-left-btn" title="Выровнять по левому краю">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      d="M1 6H23C23.2652 6 23.5196 5.89464 23.7071 5.7071C23.8946 5.51957 24 5.26521 24 5C24 4.73478 23.8946 4.48043 23.7071 4.29289C23.5196 4.10536 23.2652 4 23 4H1C0.734784 4 0.48043 4.10536 0.292893 4.29289C0.105357 4.48043 0 4.73478 0 5C0 5.26521 0.105357 5.51957 0.292893 5.7071C0.48043 5.89464 0.734784 6 1 6Z"
                      fill="#212121" />
                ...
                <button type="button" class="tiptap-button" id="desc2-align-center-btn" title="Выровнять по центру">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      d="M1 6H23C23.2652 6 23.5196 5.89464 23.7071 5.7071C23.8946 5.51957 24 5.26521 24 5C24 4.73478 23.8946 4.48043 23.7071 4.29289C23.5196 4.10536 23.2652 4 23 4H1C0.734784 4 0.48043 4.10536 0.292893 4.29289C0.105357 4.48043 0 4.73478 0 5C0 5.26521 0.105357 5.51957 0.292893 5.7071C0.48043 5.89464 0.734784 6 1 6Z"
                      fill="#212121" />
                ...
                <button type="button" class="tiptap-button" id="desc2-align-right-btn" title="Выровнять по правому краю">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      d="M1 6H23C23.2652 6 23.5196 5.89464 23.7071 5.7071C23.8946 5.51957 24 5.26521 24 5C24 4.73478 23.8946 4.48043 23.7071 4.29289C23.5196 4.10536 23.2652 4 23 4H1C0.734784 4 0.48043 4.10536 0.292893 4.29289C0.105357 4.48043 0 4.73478 0 5C0 5.26521 0.105357 5.51957 0.292893 5.7071C0.48043 5.89464 0.734784 6 1 6Z"
                      fill="#212121" />
                ...
                <button type="button" class="tiptap-button" id="desc2-indent-btn" title="Увеличить отступ">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                ...
                <button type="button" class="tiptap-button" id="desc2-list-ol-btn" title="Нумерованный список">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <button type="button" class="tiptap-button" id="desc2-list-ul-btn" title="Маркированный список">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
              ...
              <div class="input-wrapper">
                <div id="tiptap-editor-desc2" class="tiptap-editor" contenteditable="true">
                  <p>Start writing your article here...</p>
                </div>
              </div>
            </div>
            <!-- Скрытое поле для отправки данных второго редактора -->
            <textarea id="product-description2" name="description2" class="visually-hidden"></textarea>
          
            <p class="createProduct__text-subtitle">
              Upload up to 8 files of any file type for your product. Each file can be up to 100MB in size. You can upload a large video to platforms such as YouTube or Vimeo and embed the link below.
            </p>
            <ul class="createProduct__files">
              <li class="createProduct__file">
                <label class="modern-upload">
                  <input type="file" class="visually-hidden" accept="image/*" />
                  <div class="upload-area">
                    <div class="image-preview">
                      <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_3392_170345)">
                          <path
                            d="M19.949 6.03651L16.465 2.55051C15.8163 1.89865 15.0449 1.38184 14.1952 1.02997C13.3456 0.678099 12.4346 0.498144 11.515 0.500511H7C5.67441 0.502099 4.40356 1.02939 3.46622 1.96673C2.52888 2.90407 2.00159 4.17492 2 5.50051V19.5005C2.00159 20.8261 2.52888 22.097 3.46622 23.0343C4.40356 23.9716 5.67441 24.4989 7 24.5005H17C18.3256 24.4989 19.5964 23.9716 20.5338 23.0343C21.4711 22.097 21.9984 20.8261 22 19.5005V10.9855C22.0025 10.0659 21.8225 9.155 21.4704 8.30549C21.1184 7.45597 20.6012 6.68475 19.949 6.03651ZM18.535 7.45051C18.8404 7.76466 19.103 8.1177 19.316 8.50051H15C14.7348 8.50051 14.4804 8.39515 14.2929 8.20762C14.1054 8.02008 14 7.76573 14 7.50051V3.18451C14.3829 3.39744 14.7363 3.65967 15.051 3.96451L18.535 7.45051ZM20 19.5005C20 20.2962 19.6839 21.0592 19.1213 21.6218C18.5587 22.1844 17.7956 22.5005 17 22.5005H7C6.20435 22.5005 5.44129 22.1844 4.87868 21.6218C4.31607 21.0592 4 20.2962 4 19.5005V5.50051C4 4.70486 4.31607 3.9418 4.87868 3.37919C5.44129 2.81658 6.20435 2.50051 7 2.50051H11.515C11.679 2.50051 11.838 2.53251 12 2.54751V7.50051C12 8.29616 12.3161 9.05922 12.8787 9.62183C13.4413 10.1844 14.2044 10.5005 15 10.5005H19.953C19.968 10.6625 20 10.8205 20 10.9855V19.5005Z"
                            fill="#A4A0A0" />
                        </g>
                        <defs>
                          <clipPath id="clip0_3392_170345">
                ...
                <svg class="createProduct__file-plus" width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    d="M6.00045 1.75732C6.00045 5.07103 6.00045 6.9289 6.00045 10.2426M1.75781 5.99997C5.07152 5.99997 6.92939 5.99997 10.2431 5.99997"
                    stroke="#212121"
                    stroke-width="1.5"
                    stroke-linecap="round" />
                </svg>
            ...
            <p class="createProduct__files-subtitle createArticle-label">You can add a description to each file (optional)</p>
            <label for="" class="createArticle-label createProduct__videoLink-label">Video Link (Optional)</label>
            <ul class="createProduct__videoLink-list">
              <li class="createProduct__videoLink-item">
          ...
          <h4 class="createProduct__subtitle">Video Link (Optional)</h4>
          <form class="createProduct__productsDetails createProduct__links-form createProduct-wrapper">
            <ul class="createProduct__videoLink-list">
              <li class="createProduct__videoLink-item">
                <input placeholder="Link" type="text" class="input createProduct__videoLink-input" />
                <svg class="createProduct__videoLink-plus" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="createArticle__buttons createProduct__buttons">
            <div>
            <button class="createProduct__button createArticle__button-back">Back to Details</button>
          
              <button class="createProduct__button createArticle__button-save">Save as Draft</button>
            </div>
              <button class="createProduct__button createArticle__button-publish main-btn">Save & Continue</button>
