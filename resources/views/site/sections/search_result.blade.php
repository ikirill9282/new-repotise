            ...
            <div class="block_cards">
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="item">
                          @include('site.components.heading', ['title' => 'box1'])
                          <a href="{{ print_var('box1_link', $variables) }}">{{ print_var('box1_button_label', $variables) }}</a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="item">
                          @include('site.components.heading', ['title' => 'box2'])
                          <a href="{{ print_var('box2_link', $variables) }}">{{ print_var('box2_button_label', $variables) }}</a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="item">
                          @include('site.components.heading', ['title' => 'box3'])
                          <a href="{{ print_var('box3_link', $variables) }}">{{ print_var('box3_button_label', $variables) }}</a>
                        </div>
                    </div>
                </div>
            </div>
