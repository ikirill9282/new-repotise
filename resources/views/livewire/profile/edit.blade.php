                      ...
                      <div class="flex justify-start items-start gap-2 sm:gap-4 !text-sm sm:!text-base mb-4">
                          ...
                          <div class="">
                              ...
                              <div class="flex items-center gap-3 whitespace-nowrap">
                                  ...
                                  <x-form.toggle
                                    class="!m-0"
                                    wrapClass="!p-0 !bg-transparent"
                                    :tooltip="false"
                                    label=""
                                    wire:model.defer="collaboration"
                                  />
                              </div>
                              <div class="flex items-center gap-3 whitespace-nowrap">
                                  ...
                                  <select
                                      ...
                                      class="bg-light border border-gray/30 rounded px-3 py-1 text-sm outline-0"
                                      style="width: auto"
                                  >
                      ...
                      <div class="creatorPage__content-infoBlok-list">
                          ...
                          <div class="">
                            <x-form.text-editor
                              ...
                              placeholder="Share your story and travel experience"
                            />
                          </div>
                      </div>
                    </div>
                  ...
                  top-[80px] rightt-0 col-span-1 bg-white !p-2 sm:!p-4 rounded">
                    ...
                    @if(auth()->user()?->id == $user->id && auth()->user()?->hasRole('creator'))
                      <div class="flex flex-col gap-2">
                        <x-btn class="!py-2 !max-w-none" wire:click.prevent="save">Save Changes</x-btn>
                        <x-btn outlined class="!py-2 !max-w-none" wire:click.prevent="cancel">Cancel</x-btn>
                        @if (session()->has('status'))
                          <div class="text-xs text-emerald-600">{{ session('status') }}</div>
                        @endif
                      </div>
                    @else
                      <x-btn 
