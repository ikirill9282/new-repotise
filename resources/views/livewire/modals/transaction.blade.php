<div class="">
  {{-- HEADER --}}
  <div class="!text-2xl md:!text-3xl font-semibold !mb-8">Donation # [Transaction ID] - Details</div>


  {{-- DONOR --}}
  <div class="!text-xl md:!text-2xl font-semibold !mb-4">Donor Summary:</div>
  <div class="flex flex-col items-stretch justify-start !gap-4">
    <div class="flex flex-col items-stretch justify-start !gap-2">
      <div class="text-gray">Donor Username:</div>
      <div class="">[Username или "Anonymous"]</div>
    </div>

    <div class="flex flex-col items-stretch justify-start !gap-2">
      <div class="text-gray">Donor Email:</div>
      <div class="">[Донор Email или "Anonymous"]</div>
    </div>

    <div class="flex flex-col items-stretch justify-start !gap-2">
      <div class="text-gray">Stripe Customer ID:</div>
      <div class="">[Stripe Customer ID или "Anonymous"]</div>
    </div>
  </div>
  ...
  <div class="flex flex-col items-stretch justify-start !gap-4 !pb-4 sm:!pb-0">
    ...
    <div class="flex flex-col items-stretch justify-start !gap-2">
      <div class="text-gray">Payment Status:</div>
      <div class="">[Paid, etc.]</div>
    </div>
