@php
    ...
    $order = \App\Models\Order::prepare($cart);

    // $products = \App\Models\Order::prepareCartProducts($cart);
...
<div class="flex flex-col md:flex-row-reverse justify-between items-stretch gap-2 cart-modal md:min-w-3xl rounded-lg max-h-[97vh] overflow-y-scroll overflow-x-hidden md:overflow-hidden select-none">
    <div class="md:basis-1/4 order-2 md:!order-1 relative md:!pr-2">
        <div id="cart-slider" class="md:max-w-[280px] h-full overflow-hidden md:rounded-lg ">
            ...
            <div
                class="swiper-button-next hover:!cursor-pointer !z-40 md:!bottom-10 md:!top-auto md:!left-[50%] md:!right-auto md:translate-x-[-50%] md:!rotate-[90deg]">
    ...
    <div class="md:basis-3/4 bg-white pt-4 px-2 pb-2 md:p-2 rounded-lg flex flex-col">
        ...
        <a href="{{ url('/payment/checkout') }}" class="place_button">Place Order</a>
