  ...
  <div class="container">
    <div class="w-full bg-white p-2 sm:!p-6 lg:!p-10 rounded-xl">
      ...
      <div 
        ...
        @if(!auth()->check())
          <a @click.prevent="$dispatch('openModal', {modalName: 'auth'})" href="#" class="!text-[#A4A0A0] hover:!text-[#FC7361] border-b border-dashed pb-0.5 transition">Login to review</a>
        @elseif (auth()->user()->canWriteReview($model))
        @endif
