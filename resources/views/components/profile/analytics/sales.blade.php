...
<div class="!p-2 sm:!p-4 lg:!p-8 bg-light basis-1/2 rounded flex flex-col justify-start items-start gap-2">
    <div class="flex justify-start items-center gap-1.5 flex-wrap">
        ...
        <div class="text-nowrap relative !pr-6">
            ...
            <x-tooltip message="Total number of orders placed during the selected time period.">@include('icons.shield')</x-tooltip>
        </div>
    </div>
    <div class="flex justify-start items-center gap-1.5 flex-wrap">
        ...
        <div class="text-nowrap relative !pr-6">
            ...
            <x-tooltip message="Estimated recurring revenue from active subscriptions in the selected time period.">@include('icons.shield')</x-tooltip>
        </div>
    </div>
    <div class="flex justify-start items-center gap-1.5 flex-wrap">
        ...
        <div class="text-nowrap relative !pr-6">
            ...
            <x-tooltip message="Percentage of orders refunded during the selected time period.">@include('icons.shield')</x-tooltip>
        </div>
    </div>
    <div class="flex justify-start items-center gap-1.5 flex-wrap">
        ...
        <div class="text-nowrap relative !pr-6">
            ...
            <x-tooltip message="Average revenue earned per order in the selected time period.">@include('icons.shield')</x-tooltip>
        </div>
    </div>
    <div class="flex justify-start items-center gap-1.5 flex-wrap">
        ...
        <div class="text-nowrap relative !pr-6">
            ...
            <x-tooltip message="Percentage of product views that converted into purchases.">@include('icons.shield')</x-tooltip>
        </div>
    </div>
    <div class="flex justify-start items-center gap-1.5 flex-wrap">
        ...
        <div class="text-nowrap relative !pr-6">
            ...
            <x-tooltip message="Commission earned through the referral program during the selected time period.">@include('icons.shield')</x-tooltip>
        </div>
    </div>
</div>
