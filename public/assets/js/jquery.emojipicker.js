;(function($) {
  ...
  $.extend(Plugin.prototype, {
    ...
    hide: function() {
      this.$picker.parent('button').attr('data-open', false);
    ...
    show: function() {
      ...
      this.updatePosition();
      console.log();
      this.$picker.parent('button').attr('data-open', true);

      this.$picker.data('open', true);
  ...
  function getPickerHTML() {
    ...
    //     const aHasFace = a.description.toUpperCase().includes('FACE');
    //     const bHasFace = b.description.toUpperCase().includes('FACE');

    //     if (aHasFace && !bHasFace) return -1;
    //     if (!aHasFace && bHasFace) return 1;

    //     return b.unicode.localeCompare(a.unicode, 'en', { sensitivity: 'base' });
    //   });
    // }
