...
class Settings extends Component
{
    ...
    protected function refreshState(): void
    {
        ...
        $this->security['twofa'] = (bool) ($this->user->twofa ?? false);
        $this->security['password'] = '';
        $this->security['password_confirmation'] = '';
    ...
    protected function validateSecurity(): void
    {
        $this->validate([
            ...
            'security.password_confirmation' => ['nullable', 'string', 'min:8'],
    ...
    {
        if ($this->security['password'] === '' || $this->security['password'] === null) {
            $this->security['password'] = null;
        }

        if ($this->security['password_confirmation'] === '' || $this->security['password_confirmation'] === null) {
            $this->security['password_confirmation'] = null;
        }
    }
